...
namespace Database.Migrations
{
    ...
    [Migration("20230627093119_Change User-Pasword relation")]
    partial class ChangeUserPaswordrelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Database.Entities.Item", b =>
                {
                    ...
                    b.HasIndex("LabelTypeId", "LabelNumberPrefix", "LabelNumber", "LabelNumberSufix");
            ...
            modelBuilder.Entity("Database.Entities.Item", b =>
                {
                    ...
                    b.HasOne("Database.Entities.Registry", "Registry")
                        .WithMany("Items")
                        .HasForeignKey("LabelTypeId", "LabelNumberPrefix", "LabelNumber", "LabelNumberSufix")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
