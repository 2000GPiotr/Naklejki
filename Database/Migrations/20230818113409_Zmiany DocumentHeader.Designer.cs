...
namespace Database.Migrations
{
    ...
    [Migration("20230818113409_Zmiany DocumentHeader")]
    partial class ZmianyDocumentHeader
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.Item", b =>
                {
                    ...
                    b.Property<string>("LabelNumberPrefix")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("LabelNumberSufix")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("LabelTypeSymbol")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("LabelTypeSymbol", "LabelNumberPrefix", "LabelNumber", "LabelNumberSufix");
            ...
            modelBuilder.Entity("Database.Entities.RegistryItem", b =>
                {
                    ...
                    b.HasKey("LabelTypeId", "LabelNumberPrefix", "LabelNumber", "LabelNumberSufix");
            ...
            modelBuilder.Entity("Database.Entities.Item", b =>
                {
                    ...
                    b.HasOne("Database.Entities.LabelType", "LabelType")
                        .WithMany("Items")
                        .HasForeignKey("LabelTypeSymbol")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Database.Entities.RegistryItem", "Registry")
                        .WithMany("Items")
                        .HasForeignKey("LabelTypeSymbol", "LabelNumberPrefix", "LabelNumber", "LabelNumberSufix")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
